...
global $shortname, $theme_name, $font_faces, $all_page_ids, $all_category_ids, $sidebar_tabs, $suffusion_404_title, $suffusion_404_content, $all_sitemap_entities;
$templates_options = array(
	...
	array("name" => "Order of entities in magazine template",
		...
		"id" => $shortname . "_mag_entity_order",
		"parent" => "magazine-template",
		"type" => "sortable-list",
	...
	array("name" => "Magazine Template - Maximum number of excerpts",
		...
		"id" => $shortname . "_mag_total_excerpts",
		"grouping" => "mag-excerpt",
		"parent" => "magazine-template",
		"type" => "text",
	...
	array("name" => "Magazine Template - Post display style in category blocks",
		...
		"id" => $shortname . "_mag_catblocks_post_style",
		"grouping" => "mag-cat",
		"parent" => "magazine-template",
		"type" => "radio",
	...
	array("name" => "Show Tag Description",
		...
		"id" => $shortname . "_tag_info_enabled",
		"parent" => "tag-template",
		"type" => "radio",
	...
	array("name" => "Enable Search introduction?",
		...
		"id" => $shortname . "_search_info_enabled",
		"parent" => "search-template",
		"type" => "radio",
	...
	array("name" => "EXIF data to display",
		...
		"id" => $shortname . "_image_exif_pieces",
		"parent" => "att-template",
		"grouping" => "image-settings",
		"type" => "multi-select",
		"options" => suf_get_formatted_options_array($shortname . "_image_exif_pieces", array('file' => 'File Name',
			'width' => 'Width',
			'height' => 'Height',
	...
	array("name" => "Height of content",
		...
		"id" => $shortname . "_audio_att_player_height",
		"grouping" => "audio-settings",
		"parent" => "att-template",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored.",
	...
	array("name" => "Width of content",
		...
		"id" => $shortname . "_audio_att_player_width",
		"grouping" => "audio-settings",
		"parent" => "att-template",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored.",
	...
	array("name" => "Application template",
		...
		"id" => $shortname . "_application_att_type",
		"parent" => "att-template",
	...
	array("name" => "Width of content",
		"desc" => "You can set the width of the embedded content: ",
		"id" => $shortname . "_application_att_player_width",
		"grouping" => "app-settings",
		"parent" => "att-template",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored.",
	...
	array("name" => "Width of content",
		"desc" => "You can set the width of the embedded content: ",
		"id" => $shortname . "_text_att_player_width",
		"grouping" => "text-settings",
		"parent" => "att-template",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored.",
	...
	array("name" => "Height of content",
		"desc" => "You can set the height of the embedded content: ",
		"id" => $shortname . "_video_att_player_height",
		"grouping" => "video-settings",
		"parent" => "att-template",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored.",
	...
	array("name" => "Width of content",
		"desc" => "You can set the width of the embedded content: ",
		"id" => $shortname . "_video_att_player_width",
		"grouping" => "video-settings",
		"parent" => "att-template",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored.",
	...
	array("name" => "Contents of Sitemap",
		...
		"id" => $shortname . "_sitemap_contents",
		"parent" => "sitemap-template",
		"type" => "multi-select",
		"options" => suffusion_get_formatted_sitemap_contents_array('suf_sitemap_contents'),
		'std' => $all_sitemap_entities,
	),

	array("name" => "Label for Pages",
		"id" => $shortname . "_sitemap_label_pages",
		"parent" => "sitemap-template",
		"type" => "text",
		"std" => "Pages"),

	array("name" => "Label for Categories",
		"id" => $shortname . "_sitemap_label_categories",
		"parent" => "sitemap-template",
		"type" => "text",
		"std" => "Categories"),

	array("name" => "Label for Authors",
		"id" => $shortname . "_sitemap_label_authors",
		"parent" => "sitemap-template",
		"type" => "text",
		"std" => "Authors"),

	array("name" => "Label for Yearly Archives",
		"id" => $shortname . "_sitemap_label_yarchives",
		"parent" => "sitemap-template",
		"type" => "text",
		"std" => "Yearly Archives"),

	array("name" => "Label for Monthly Archives",
		"id" => $shortname . "_sitemap_label_marchives",
		"parent" => "sitemap-template",
		"type" => "text",
		"std" => "Monthly Archives"),

	array("name" => "Label for Weekly Archives",
		"id" => $shortname . "_sitemap_label_warchives",
		"parent" => "sitemap-template",
		"type" => "text",
		"std" => "Weekly Archives"),

	array("name" => "Label for Daily Archives",
		"id" => $shortname . "_sitemap_label_darchives",
		"parent" => "sitemap-template",
		"type" => "text",
		"std" => "Daily Archives"),

	array("name" => "Label for Tags",
		"id" => $shortname . "_sitemap_label_tags",
		"parent" => "sitemap-template",
		"type" => "text",
		"std" => "Tags"),

	array("name" => "Label for Blog Posts",
		"id" => $shortname . "_sitemap_label_posts",
		"parent" => "sitemap-template",
		"type" => "text",
		"std" => "Blog Posts"),
	...
	array("name" => "Sequence of Sitemap Contents",
		...
		"id" => $shortname . "_sitemap_entity_order",
		"parent" => "sitemap-template",
		"type" => "sortable-list",
	...
	array("name" => "Page Width Type",
		...
		"id" => $shortname . "_1l_wrapper_width_type",
		"parent" => "1l-sidebar",
		"type" => "radio",
	...
	array("name" => "Width of page",
		"id" => $shortname . "_1l_wrapper_width_flex",
		"parent" => "1l-sidebar",
	...
	array("name" => "Maximum width",
		...
		"id" => $shortname . "_1l_wrapper_width_flex_max",
		"parent" => "1l-sidebar",
		"grouping" => "1l-size-flexible",
		"type" => "text",
	...
	array("name" => "Minimum width",
		...
		"id" => $shortname . "_1l_wrapper_width_flex_min",
		"parent" => "1l-sidebar",
		"grouping" => "1l-size-flexible",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Value will be set to a default if blank or incompatible.",
	...
	array("name" => "Overall Page Width",
		...
		"id" => $shortname . "_1l_wrapper_width_preset",
		"parent" => "1l-sidebar",
	...
	array("name" => "Custom value for page width",
		...
		"id" => $shortname . "_1l_wrapper_width",
		"parent" => "1l-sidebar",
		"grouping" => "1l-size-fixed",
		"type" => "text",
	...
	array("name" => "Custom component width - Custom value for main column width",
		...
		"id" => $shortname . "_1l_main_col_width",
		"parent" => "1l-sidebar",
		"grouping" => "1l-size-fixed",
		"type" => "text",
	...
	array("name" => "Page Width Type",
		"desc" => "Your page can be fixed width or fluid/elastic width",
		"id" => $shortname . "_1r_wrapper_width_type",
		"parent" => "1r-sidebar",
		"type" => "radio",
		"options" => array("fixed" => "Fixed width", "fluid" => "Fluid/Flexible width"),
		"std" => "fixed"),
	...
	array("name" => "Width of page",
		"id" => $shortname . "_1r_wrapper_width_flex",
		"parent" => "1r-sidebar",
	...
	array("name" => "Maximum width",
		"desc" => "Set this value so that your typography stays consistent on large screens.",
		"id" => $shortname . "_1r_wrapper_width_flex_max",
		"parent" => "1r-sidebar",
		"grouping" => "1r-size-flexible",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Value will be set to a default if blank or incompatible.",
	...
	array("name" => "Minimum width",
		"desc" => "Set this value so that your typography stays consistent on small screens.",
		"id" => $shortname . "_1r_wrapper_width_flex_min",
		"parent" => "1r-sidebar",
		"grouping" => "1r-size-flexible",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Value will be set to a default if blank or incompatible.",
	...
	array("name" => "Overall Page Width",
		"desc" => "Suffusion comes with 3 preset page width options: 800px, 1000px and 1200px. You can also define a custom width if you please, or allow the width of the page to be determined by the width of its main components like the sidebars and the main content column.
				Due to difficulties with fitting things on the page, the minimum size allowed is 600px. If you enter something less than 600, it is considered to be 600.",
		"id" => $shortname . "_1r_wrapper_width_preset",
		"parent" => "1r-sidebar",
	...
	array("name" => "Custom value for page width",
		"desc" => "If you have selected \"Custom width\" above, you can set the width here. Please enter the width in pixels. <b>Do not enter \"px\".</b>
				Anything below 600 will be treated as 600. Note that this is a fixed width theme, not a fluid theme. What this means is that you cannot specify things like \"80%\" as the width.
				Also note that if you are setting a width over here with the \"Custom width\" selection in place, the widths of the individual components like the main column, the sidebars etc. are auto-calculated",
		"id" => $shortname . "_1r_wrapper_width",
		"parent" => "1r-sidebar",
		"grouping" => "1r-size-fixed",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored. Incompatible values will be treated as 1000",
	...
	array("name" => "Custom component width - Custom value for main column width",
		"desc" => "If you have selected \"Custom width, but constructed from individual components\" above, you can set the width here for the main column.
				Please enter the width in pixels. <b>Do not enter \"px\".</b>
				Anything below 380 will be treated as 380. Note that this is a fixed width theme, not a fluid theme. What this means is that you cannot specify things like \"80%\" as the width. ",
		"id" => $shortname . "_1r_main_col_width",
		"parent" => "1r-sidebar",
		"grouping" => "1r-size-fixed",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored. Incompatible values will be treated as 725",
	...
	array("name" => "Page Width Type",
		"desc" => "Your page can be fixed width or fluid/elastic width",
		"id" => $shortname . "_1l1r_wrapper_width_type",
		"parent" => "1l1r-sidebar",
		"type" => "radio",
		"options" => array("fixed" => "Fixed width", "fluid" => "Fluid/Flexible width"),
		"std" => "fixed"),
	...
	array("name" => "Width of page",
		"id" => $shortname . "_1l1r_wrapper_width_flex",
		"parent" => "1l1r-sidebar",
	...
	array("name" => "Minimum width",
		"desc" => "Set this value so that your typography stays consistent on small screens.",
		"id" => $shortname . "_1l1r_wrapper_width_flex_min",
		"parent" => "1l1r-sidebar",
		"grouping" => "1l1r-size-flexible",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Value will be set to a default if blank or incompatible.",
	...
	array("name" => "Overall Page Width",
		"desc" => "Suffusion comes with 3 preset page width options: 800px, 1000px and 1200px. You can also define a custom width if you please, or allow the width of the page to be determined by the width of its main components like the sidebars and the main content column.
				Due to difficulties with fitting things on the page, the minimum size allowed is 600px. If you enter something less than 600, it is considered to be 600.",
		"id" => $shortname . "_1l1r_wrapper_width_preset",
		"parent" => "1l1r-sidebar",
	...
	array("name" => "Custom value for page width",
		"desc" => "If you have selected \"Custom width\" above, you can set the width here. Please enter the width in pixels. <b>Do not enter \"px\".</b>
				Anything below 600 will be treated as 600. Note that this is a fixed width theme, not a fluid theme. What this means is that you cannot specify things like \"80%\" as the width.
				Also note that if you are setting a width over here with the \"Custom width\" selection in place, the widths of the individual components like the main column, the sidebars etc. are auto-calculated",
		"id" => $shortname . "_1l1r_wrapper_width",
		"parent" => "1l1r-sidebar",
		"grouping" => "1l1r-size-fixed",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored. Incompatible values will be treated as 1000",
	...
	array("name" => "Custom component width - Custom value for main column width",
		"desc" => "If you have selected \"Custom width, but constructed from individual components\" above, you can set the width here for the main column.
				Please enter the width in pixels. <b>Do not enter \"px\".</b>
				Anything below 380 will be treated as 380. Note that this is a fixed width theme, not a fluid theme. What this means is that you cannot specify things like \"80%\" as the width. ",
		"id" => $shortname . "_1l1r_main_col_width",
		"parent" => "1l1r-sidebar",
		"grouping" => "1l1r-size-fixed",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored. Incompatible values will be treated as 725",
	...
	array("name" => "Page Width Type",
		"desc" => "Your page can be fixed width or fluid/elastic width",
		"id" => $shortname . "_2l_wrapper_width_type",
		"parent" => "2l-sidebars",
		"type" => "radio",
		"options" => array("fixed" => "Fixed width", "fluid" => "Fluid/Flexible width"),
		"std" => "fixed"),
	...
	array("name" => "Width of page",
		"id" => $shortname . "_2l_wrapper_width_flex",
		"parent" => "2l-sidebars",
	...
	array("name" => "Maximum width",
		"desc" => "Set this value so that your typography stays consistent on large screens.",
		"id" => $shortname . "_2l_wrapper_width_flex_max",
		"parent" => "2l-sidebars",
		"grouping" => "2l-size-flexible",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Value will be set to a default if blank or incompatible.",
	...
	array("name" => "Minimum width",
		"desc" => "Set this value so that your typography stays consistent on small screens.",
		"id" => $shortname . "_2l_wrapper_width_flex_min",
		"parent" => "2l-sidebars",
		"grouping" => "2l-size-flexible",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Value will be set to a default if blank or incompatible.",
	...
	array("name" => "Overall Page Width",
		"desc" => "Suffusion comes with 3 preset page width options: 800px, 1000px and 1200px. You can also define a custom width if you please, or allow the width of the page to be determined by the width of its main components like the sidebars and the main content column.
				Due to difficulties with fitting things on the page, the minimum size allowed is 600px. If you enter something less than 600, it is considered to be 600.",
		"id" => $shortname . "_2l_wrapper_width_preset",
		"parent" => "2l-sidebars",
	...
	array("name" => "Custom value for page width",
		"desc" => "If you have selected \"Custom width\" above, you can set the width here. Please enter the width in pixels. <b>Do not enter \"px\".</b>
				Anything below 600 will be treated as 600. Note that this is a fixed width theme, not a fluid theme. What this means is that you cannot specify things like \"80%\" as the width.
				Also note that if you are setting a width over here with the \"Custom width\" selection in place, the widths of the individual components like the main column, the sidebars etc. are auto-calculated",
		"id" => $shortname . "_2l_wrapper_width",
		"parent" => "2l-sidebars",
		"grouping" => "2l-size-fixed",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored. Incompatible values will be treated as 1000",
	...
	array("name" => "Custom component width - Custom value for main column width",
		"desc" => "If you have selected \"Custom width, but constructed from individual components\" above, you can set the width here for the main column.
				Please enter the width in pixels. <b>Do not enter \"px\".</b>
				Anything below 380 will be treated as 380. Note that this is a fixed width theme, not a fluid theme. What this means is that you cannot specify things like \"80%\" as the width. ",
		"id" => $shortname . "_2l_main_col_width",
		"parent" => "2l-sidebars",
		"grouping" => "2l-size-fixed",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored. Incompatible values will be treated as 725",
	...
	array("name" => "Page Width Type",
		"desc" => "Your page can be fixed width or fluid/elastic width",
		"id" => $shortname . "_2r_wrapper_width_type",
		"parent" => "2r-sidebars",
		"type" => "radio",
		"options" => array("fixed" => "Fixed width", "fluid" => "Fluid/Flexible width"),
		"std" => "fixed"),
	...
	array("name" => "Width of page",
		"id" => $shortname . "_2r_wrapper_width_flex",
		"parent" => "2r-sidebars",
	...
	array("name" => "Maximum width",
		"desc" => "Set this value so that your typography stays consistent on large screens.",
		"id" => $shortname . "_2r_wrapper_width_flex_max",
		"parent" => "2r-sidebars",
		"grouping" => "2r-size-flexible",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Value will be set to a default if blank or incompatible.",
	...
	array("name" => "Minimum width",
		"desc" => "Set this value so that your typography stays consistent on small screens.",
		"id" => $shortname . "_2r_wrapper_width_flex_min",
		"parent" => "2r-sidebars",
		"grouping" => "2r-size-flexible",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Value will be set to a default if blank or incompatible.",
	...
	array("name" => "Overall Page Width",
		"desc" => "Suffusion comes with 3 preset page width options: 800px, 1000px and 1200px. You can also define a custom width if you please, or allow the width of the page to be determined by the width of its main components like the sidebars and the main content column.
				Due to difficulties with fitting things on the page, the minimum size allowed is 600px. If you enter something less than 600, it is considered to be 600.",
		"id" => $shortname . "_2r_wrapper_width_preset",
		"parent" => "2r-sidebars",
	...
	array("name" => "Custom value for page width",
		"desc" => "If you have selected \"Custom width\" above, you can set the width here. Please enter the width in pixels. <b>Do not enter \"px\".</b>
				Anything below 600 will be treated as 600. Note that this is a fixed width theme, not a fluid theme. What this means is that you cannot specify things like \"80%\" as the width.
				Also note that if you are setting a width over here with the \"Custom width\" selection in place, the widths of the individual components like the main column, the sidebars etc. are auto-calculated",
		"id" => $shortname . "_2r_wrapper_width",
		"parent" => "2r-sidebars",
		"grouping" => "2r-size-fixed",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored. Incompatible values will be treated as 1000",
	...
	array("name" => "Custom component width - Custom value for main column width",
		"desc" => "If you have selected \"Custom width, but constructed from individual components\" above, you can set the width here for the main column.
				Please enter the width in pixels. <b>Do not enter \"px\".</b>
				Anything below 380 will be treated as 380. Note that this is a fixed width theme, not a fluid theme. What this means is that you cannot specify things like \"80%\" as the width. ",
		"id" => $shortname . "_2r_main_col_width",
		"parent" => "2r-sidebars",
		"grouping" => "2r-size-fixed",
		"type" => "text",
		"hint" => "Enter the number of pixels here (don't enter 'px'). Non-integers will be ignored. Incompatible values will be treated as 725",
	...
	array("name" => "Number of Books per row",
		...
		"id" => $shortname . "_nr_books_per_row",
		"parent" => "nr-template",
		"grouping" => "nr-general",
		"type" => "select",
		"options" => array("1" => "1 (One)", "2" => "2 (Two)", "3" => "3 (Three)", "4" => "4 (Four)", "5" => "5 (Five)", "6" => "6 (Six)", "7" => "7 (Seven)",
	...
	array("name" => "Text if no books are found for a section",
		...
		"id" => $shortname . "_nr_no_books_text",
		"parent" => "nr-template",
		"grouping" => "nr-general",
		"type" => "textarea",
		"std" => "None"),
	...
	array("name" => "Display Currently Reading Books",
		...
		"id" => $shortname . "_nr_lib_curr_show",
		"parent" => "nr-template",
		"grouping" => "nr-lib",
		"type" => "radio",
		"options" => array("show" => "Show", "hide" => "Hide"),
	...
	array("name" => "Section title for Currently Reading Books",
		"id" => $shortname . "_nr_lib_curr_title",
		"parent" => "nr-template",
		"grouping" => "nr-lib",
		"type" => "text",
	...
	array("name" => "Section text for Currently Reading Books",
		...
		"id" => $shortname . "_nr_lib_curr_text",
		"parent" => "nr-template",
		"grouping" => "nr-lib",
		"type" => "textarea",
		"std" => ""),
	...
	array("name" => "Display Unread Books",
		...
		"id" => $shortname . "_nr_lib_unread_show",
		"parent" => "nr-template",
		"grouping" => "nr-lib",
		"type" => "radio",
		"options" => array("show" => "Show", "hide" => "Hide"),
	...
	array("name" => "Section title for Unread Books",
		"id" => $shortname . "_nr_lib_unread_title",
		"parent" => "nr-template",
		"grouping" => "nr-lib",
		"type" => "text",
		"std" => "Up Next"),
	...
	array("name" => "Section text for Unread Books",
		...
		"id" => $shortname . "_nr_lib_unread_text",
		"parent" => "nr-template",
		"grouping" => "nr-lib",
		"type" => "textarea",
		"std" => ""),
	...
	array("name" => "Display Completed Books",
		...
		"id" => $shortname . "_nr_lib_completed_show",
		"parent" => "nr-template",
		"grouping" => "nr-lib",
		"type" => "radio",
		"options" => array("show" => "Show", "hide" => "Hide"),
	...
	array("name" => "Section title for Completed Books",
		"id" => $shortname . "_nr_lib_completed_title",
		"parent" => "nr-template",
		"grouping" => "nr-lib",
		"type" => "text",
	...
	array("name" => "Section text for Completed Books",
		...
		"id" => $shortname . "_nr_lib_completed_text",
		"parent" => "nr-template",
		"grouping" => "nr-lib",
		"type" => "textarea",
		"std" => ""),
	...
	array("name" => "Reading statistics: Show when book was added to library",
		...
		"id" => $shortname . "_nr_single_added_show",
		"parent" => "nr-template",
		"grouping" => "nr-single",
		"type" => "radio",
		"options" => array("show" => "Show", "hide" => "Hide"),
	...
	array("name" => "Reading statistics: Tagline for when you added this book",
		"id" => $shortname . "_nr_single_added_text",
		"parent" => "nr-template",
		"grouping" => "nr-single",
		"type" => "text",
		"std" => "Added on: "),
	...
	array("name" => "Reading statistics: Show when you began reading this book",
		"desc" => "This text will be displayed below the book's image",
		"id" => $shortname . "_nr_single_started_show",
		"parent" => "nr-template",
		"grouping" => "nr-single",
		"type" => "radio",
		"options" => array("show" => "Show", "hide" => "Hide"),
	...
	array("name" => "Reading statistics: Tagline for when you began reading this book",
		"id" => $shortname . "_nr_single_started_text",
		"parent" => "nr-template",
		"grouping" => "nr-single",
		"type" => "text",
		"std" => "Started: "),
	...
	array("name" => "Reading statistics: Show when you finished reading this book",
		"desc" => "This text will be displayed below the book's image",
		"id" => $shortname . "_nr_single_finished_show",
		"parent" => "nr-template",
		"grouping" => "nr-single",
		"type" => "radio",
		"options" => array("show" => "Show", "hide" => "Hide"),
	...
	array("name" => "Reading statistics: Tagline for when you finished reading this book",
		"id" => $shortname . "_nr_single_finished_text",
		"parent" => "nr-template",
		"grouping" => "nr-single",
		"type" => "text",
		"std" => "Finished: "),
	...
	array("name" => "Show meta information about the book",
		...
		"id" => $shortname . "_nr_single_meta_show",
		"parent" => "nr-template",
		"grouping" => "nr-single",
		"type" => "radio",
		"options" => array("show" => "Show", "hide" => "Hide"),
	...
	array("name" => "Display Library Search",
		...
		"id" => $shortname . "_nr_wid_search_show",
		"parent" => "nr-template",
		"grouping" => "nr-w",
		"type" => "select",
	...
	array("name" => "Display Currently Reading Books",
		"desc" => "Choose if you want to display the \"Currently Reading\" section",
		"id" => $shortname . "_nr_wid_curr_show",
		"parent" => "nr-template",
		"grouping" => "nr-w",
		"type" => "radio",
		"options" => array("show" => "Show", "hide" => "Hide"),
	...
	array("name" => "Section title for Currently Reading Books",
		"id" => $shortname . "_nr_wid_curr_title",
		"parent" => "nr-template",
		"grouping" => "nr-w",
		"type" => "text",
		"std" => "Currently Reading"),
	...
	array("name" => "Display Unread Books",
		"desc" => "Choose if you want to display the \"Unread\" section",
		"id" => $shortname . "_nr_wid_unread_show",
		"parent" => "nr-template",
		"grouping" => "nr-w",
		"type" => "radio",
		"options" => array("show" => "Show", "hide" => "Hide"),
	...
	array("name" => "Section title for Unread Books",
		"id" => $shortname . "_nr_wid_unread_title",
		"parent" => "nr-template",
		"grouping" => "nr-w",
		"type" => "text",
		"std" => "Up Next"),
	...
	array("name" => "Display Completed Books",
		"desc" => "Choose if you want to display the \"Completed\" section",
		"id" => $shortname . "_nr_wid_completed_show",
		"parent" => "nr-template",
		"grouping" => "nr-w",
		"type" => "radio",
		"options" => array("show" => "Show", "hide" => "Hide"),
	...
	array("name" => "Section title for Completed Books",
		"id" => $shortname . "_nr_wid_completed_title",
		"parent" => "nr-template",
		"grouping" => "nr-w",
		"type" => "text",
		"std" => "Finished Reading"),
