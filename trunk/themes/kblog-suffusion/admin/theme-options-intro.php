...
$intro_options = array(
	...
	array("name" => "Don't Panic!!",
		"desc" => "Welcome to Suffusion! But first...<br/>
			<div class='centered'><img src='". get_template_directory_uri(). "/admin/images/dont-panic.jpg' alt=\"Don't Panic!\" title=\"Don't Panic!\" /><br/>
			<i>(This picture is from Buena Vista Pictures Distributions' promo of, obviously, \"Hitchhiker's Guide to the Galaxy\".)</i></div>
