...
class Suffusion_Featured_Posts extends WP_Widget {
	function Suffusion_Featured_Posts() {
		$widget_ops = array('classname' => 'widget-suf-featured-posts',
			'description' => __("A widget for displaying featured posts.", "suf_theme"));
		$control_ops = array('width' => 750);
		$this->WP_Widget("suf-featured-posts", __("Featured Content", "suf_theme"), $widget_ops, $control_ops);
	}
	...
	function form($instance) {
		$defaults = array("title" => "",
            ...
            'show_index' => true,
            'show_controls' => true,
            'prev_text' => __('Previous Post', 'suf_theme'),
            'pause_text' => __('Pause', 'suf_theme'),
            'next_text' => __('Next Post', 'suf_theme'),
		);
...
<?php
		_e("<p>This widget displays a featured posts slider.</p>", "suf_theme");
?>
		<p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number_of_posts' ); ?>"><?php _e('Maximum number of posts / pages to display:', 'suf_theme'); ?></label>
...
?>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_sticky'); ?>"><?php _e('Include sticky posts', 'suf_theme'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('latest_posts'); ?>"><?php _e('Include latest posts', 'suf_theme'); ?></label>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('number_of_latest_posts'); ?>"><?php _e('Number of "Latest Posts":', 'suf_theme'); ?></label>
...
?>
			...
			<i><?php _e("If you are including latest posts and you select 5 here, the latest 5 posts will be included in the featured content. If this number is higher than the maximum number of posts, this setting will be ignored", "suf_theme"); ?></i>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('featured_categories'); ?>"><?php _e('Include categories:', 'suf_theme'); ?></label>
			...
			<i><?php _e("Fill in a comma-separated list of category ids. E.g. 3,8,17", "suf_theme"); ?></i>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('featured_posts'); ?>"><?php _e('Include posts:', 'suf_theme'); ?></label>
			...
			<i><?php _e("Fill in a comma-separated list of post ids. E.g. 7,9,13", "suf_theme"); ?></i>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('featured_pages'); ?>"><?php _e('Include pages:', 'suf_theme'); ?></label>
			...
			<i><?php _e("Fill in a comma-separated list of page ids. E.g. 7,9,13", "suf_theme"); ?></i>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('transition_effect'); ?>"><?php _e('Featured content transition effect:', 'suf_theme'); ?></label>
			<select id="<?php echo $this->get_field_id('transition_effect'); ?>" name="<?php echo $this->get_field_name( 'transition_effect' ); ?>">
<?php
        $effects = array("fade" => __("Fade In", 'suf_theme'), "scrollUp" => __("Scroll Up", 'suf_theme'), "scrollDown" => __("Scroll Down", 'suf_theme'),
            "scrollLeft" => __("Scroll Left", 'suf_theme'), "scrollRight" => __("Scroll Right", 'suf_theme'), "scrollHorz" => __("Scroll Horizontally", 'suf_theme'),
            "scrollVert" => __("Scroll Vertically", 'suf_theme'), "slideX" => __("Slide in and back horizontally", 'suf_theme'),
            "slideY" => __("Slide in and back vertically", 'suf_theme'), "turnUp" => __("Turn Upwards", 'suf_theme'), "turnDown" => __("Turn Downwards", 'suf_theme'),
            "turnLeft" => __("Turn Leftwards", 'suf_theme'), "turnRight" => __("Turn Rightwards", 'suf_theme'), "zoom" => __("Zoom", 'suf_theme'),
            "fadeZoom" => __("Zoom and Fade", 'suf_theme'), "blindX" => __("Vertical Blinds", 'suf_theme'), "blindY" => __("Horizontal Blinds", 'suf_theme'),
            "blindZ" => __("Diagonal Blinds", 'suf_theme'), "growX" => __("Grow horizontally from center", 'suf_theme'),
            "growY" => __("Grow vertically from center", 'suf_theme'), "curtainX" => __("Squeeze in both edges horizontally", 'suf_theme'),
            "curtainY" => __("Squeeze in both edges vertically", 'suf_theme'), "cover" => __("Current post is covered by next post", 'suf_theme'),
            "uncover" => __("Current post moves off next post", 'suf_theme'), "wipe" => __("Wipe", 'suf_theme'),
			);
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('frame_time'); ?>"><?php _e('Time for each post display:', 'suf_theme'); ?></label>
			...
			<i><?php _e("Enter time in milliseconds. E.g. 4000", "suf_theme"); ?></i>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('frame_delay'); ?>"><?php _e('Time for each post display:', 'suf_theme'); ?></label>
			...
			<i><?php _e("Enter time in milliseconds. E.g. 1000", "suf_theme"); ?></i>
		</p>

	</div>
	<div style='float: right; width: 48%;'>
		<p>
			<label for="<?php echo $this->get_field_id('featured_height'); ?>"><?php _e('Height of featured content section:', 'suf_theme'); ?></label>
			...
			<i><?php _e("E.g. 250px", "suf_theme"); ?></i>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('custom_image_size'); ?>"><?php _e('Enable custom image size for featured images', 'suf_theme'); ?></label>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('custom_img_height'); ?>"><?php _e('Custom image height:', 'suf_theme'); ?></label>
			...
			<i><?php _e("This is applicable only if custom image size is enabled", "suf_theme"); ?></i>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('custom_img_width'); ?>"><?php _e('Custom image width:', 'suf_theme'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'text_display' ); ?>"><?php _e('Text display options:', 'suf_theme'); ?></label>
			<select id="<?php echo $this->get_field_id( 'text_display' ); ?>" name="<?php echo $this->get_field_name( 'text_display' ); ?>">
<?php
        $text_options = array("title-excerpt" => __("Show post title and excerpt", 'suf_theme'), "title" => __("Show post title only (no excerpt)", 'suf_theme'),
				"excerpt" => __("Show excerpt only (no title)", 'suf_theme'), "none" => __("Don't show any text", 'suf_theme'));
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'excerpt_position' ); ?>"><?php _e('Position of the excerpt:', 'suf_theme'); ?></label>
			<select id="<?php echo $this->get_field_id( 'excerpt_position' ); ?>" name="<?php echo $this->get_field_name( 'excerpt_position' ); ?>">
<?php
        $excerpt_positions = array("top" => __("Top", 'suf_theme'), "bottom" => __("Bottom", 'suf_theme'), "right" => __("Right", 'suf_theme'), "left" => __("Left", 'suf_theme'),
				"alttb" => __("Alternate excerpt between top and bottom", 'suf_theme'), "altlr" => __("Alternate excerpt between left and right", 'suf_theme'),
				"rotate" => __("Rotate between the four positions", 'suf_theme'));
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('text_width'); ?>"><?php _e('Width of excerpt section:', 'suf_theme'); ?></label>
			...
			<i><?php _e("This is only applicable if your excerpt is at the right or at the left of your featured posts.", "suf_theme"); ?></i>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('text_bg_color'); ?>"><?php _e('Excerpt background color:', 'suf_theme'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('link_color'); ?>"><?php _e('Excerpt title color:', 'suf_theme'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('text_color'); ?>"><?php _e('Excerpt font color:', 'suf_theme'); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_index'); ?>"><?php _e('Show a numbered post index', 'suf_theme'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_controls' ); ?>"><?php _e('Show Previous, Pause and Next buttons', 'suf_theme'); ?></label>
		</p>

        <p>
			<i><?php _e("The following three settings only apply if you show the previous, pause and next buttons:", "suf_theme"); ?></i>
        </p>

		<p>
			<label for="<?php echo $this->get_field_id('prev_text'); ?>"><?php _e('Text for "Previous Post":', 'suf_theme'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('pause_text'); ?>"><?php _e('Text for "Pause":', 'suf_theme'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('next_text'); ?>"><?php _e('Text for "Next Post":', 'suf_theme'); ?></label>
...
<?php
    ...
    function widget( $args, $instance ) {
        ...
        $ret = $this->suf_get_widget_featured_content($widget_id, $number_of_posts, $show_sticky, $latest_posts, $number_of_latest_posts,
    ...
    function suf_get_widget_featured_content($widget_id, $number_of_posts, $show_sticky, $latest_posts, $number_of_latest_posts,
            $featured_categories, $featured_posts, $featured_pages, $excerpt_position, $text_display, $text_width, $text_bg_color, $text_color, $link_color,
            $featured_height, $custom_image_size,$custom_img_height, $custom_img_width, $show_index, $show_controls, $prev_text, $pause_text, $next_text) {
        ...
        if ($total_count > 0) {
            ...
            if (isset($sticky_query)) {
	            $ret .= $this->suffusion_widget_parse_featured_query_results($sticky_query, $do_not_duplicate, $featured_excerpt_position, $featured_post_counter,
            ...
            if (isset($latest_query)) {
	            $ret .= $this->suffusion_widget_parse_featured_query_results($latest_query, $do_not_duplicate, $featured_excerpt_position, $featured_post_counter,
	                $number_of_posts, $excerpt_position, $position, $rotation, $alttb, $altlr, $text_display, $text_width, $text_bg_color, $text_color, $link_color,
	                $featured_height, $custom_image_size,$custom_img_height, $custom_img_width);
            }
            if (isset($cat_query)) {
	            $ret .= $this->suffusion_widget_parse_featured_query_results($cat_query, $do_not_duplicate, $featured_excerpt_position, $featured_post_counter,
	                $number_of_posts, $excerpt_position, $position, $rotation, $alttb, $altlr, $text_display, $text_width, $text_bg_color, $text_color, $link_color,
	                $featured_height, $custom_image_size,$custom_img_height, $custom_img_width);
            }
            if (isset($post_query)) {
	            $ret .= $this->suffusion_widget_parse_featured_query_results($post_query, $do_not_duplicate, $featured_excerpt_position, $featured_post_counter,
	                $number_of_posts, $excerpt_position, $position, $rotation, $alttb, $altlr, $text_display, $text_width, $text_bg_color, $text_color, $link_color,
	                $featured_height, $custom_image_size,$custom_img_height, $custom_img_width);
            }
            if (isset($page_query)) {
	            $ret .= $this->suffusion_widget_parse_featured_query_results($page_query, $do_not_duplicate, $featured_excerpt_position, $featured_post_counter,
	                $number_of_posts, $excerpt_position, $position, $rotation, $alttb, $altlr, $text_display, $text_width, $text_bg_color, $text_color, $link_color,
	                $featured_height, $custom_image_size,$custom_img_height, $custom_img_width);
            }
            $ret .= "\t\t</ul>";
            $ret .= "\t</div>";
            $ret .= $this->suffusion_widget_display_featured_pager($widget_id, $show_index, $show_controls, $prev_text, $pause_text, $next_text);
            $ret .= "</div>";
        }
        return $ret;
    }

    function suffusion_widget_parse_featured_query_results($query, &$do_not_duplicate, &$featured_excerpt_position, &$featured_post_counter,
            $number_of_posts, $excerpt_position, &$position, $rotation, $alttb, $altlr, $text_display, $text_width, $text_bg_color, $text_color, $link_color,
            $featured_height, $custom_image_size,$custom_img_height, $custom_img_width) {
        global $post;
        $ret = "";
        if (isset($query->posts) && is_array($query->posts)) {
            while ($query->have_posts())  {
                ...
                $ret .= $this->suffusion_widget_display_single_featured_post($featured_excerpt_position, $position, $text_display, $text_width, $text_bg_color,
    ...
    function suffusion_widget_display_single_featured_post($featured_excerpt_position, $position, $text_display, $text_width,
    ...
    function suffusion_widget_display_featured_pager($widget_id, $show_index, $show_controls, $prev_text, $pause_text, $next_text) {
        $ret = "";
