...
class Suffusion_Google_Translator extends WP_Widget {
	function Suffusion_Google_Translator() {
		$widget_ops = array('classname' => 'widget-suf-google-translator', 'description' => __("A widget to let people use Google Translator to translate your site", "suf_theme"));
		$this->WP_Widget("suf-google-translator", __("Google Translator", "suf_theme"), $widget_ops);
...
<?php
	...
	function form($instance) {
		$defaults = array("title" => __("Translate this Page", "suf_theme"),
			"source_lang" => 'en',
			"show_flag" => true,
		);
...
<div style='display: inline-block; clear: both;'>
		...
		<p>
			<label for="<?php echo $this->get_field_id('source_lang'); ?>"><?php _e('Source Language:', 'suf_theme'); ?></label>
			...
			<i><?php _e("What language is your page in?", "suf_theme"); ?></i>
		</p>
</div>
<?php
	}
