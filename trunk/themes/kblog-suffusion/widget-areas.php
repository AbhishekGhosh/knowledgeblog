...
global $suffusion_unified_options, $suffusion_options;
...
register_sidebar(array(
	...
	'before_widget' => $sidebar_definitions['sidebar-1'][$suf_wa_sb1_style]['before_widget'],
	'after_widget' => $sidebar_definitions['sidebar-1'][$suf_wa_sb1_style]['after_widget'],
	'before_title' => $sidebar_definitions['sidebar-1'][$suf_wa_sb1_style]['before_title'],
	'after_title' => $sidebar_definitions['sidebar-1'][$suf_wa_sb1_style]['after_title'],
));
register_sidebar(array(
	'name' => 'Sidebar 1 (Bottom)',
	'id' => 'sidebar-9',
	"description" => "This sits below Sidebar 1 and is positioned on the same side as Sidebar 1",
	'before_widget' => $sidebar_definitions['sidebar-1'][$suf_wa_sb1b_style]['before_widget'],
	'after_widget' => $sidebar_definitions['sidebar-1'][$suf_wa_sb1b_style]['after_widget'],
	'before_title' => $sidebar_definitions['sidebar-1'][$suf_wa_sb1b_style]['before_title'],
	'after_title' => $sidebar_definitions['sidebar-1'][$suf_wa_sb1b_style]['after_title'],
));
register_sidebar(array(
	'name' => 'Sidebar 2',
	'id' => 'sidebar-2',
	...
	'before_widget' => $sidebar_definitions['sidebar-2'][$suf_wa_sb2_style]['before_widget'],
	'after_widget' => $sidebar_definitions['sidebar-2'][$suf_wa_sb2_style]['after_widget'],
	'before_title' => $sidebar_definitions['sidebar-2'][$suf_wa_sb2_style]['before_title'],
	'after_title' => $sidebar_definitions['sidebar-2'][$suf_wa_sb2_style]['after_title'],
));
register_sidebar(array(
	'name' => 'Sidebar 2 (Bottom)',
	'id' => 'sidebar-10',
	"description" => "This sits below Sidebar 2 and is positioned on the same side as Sidebar 2",
	'before_widget' => $sidebar_definitions['sidebar-2'][$suf_wa_sb2b_style]['before_widget'],
	'after_widget' => $sidebar_definitions['sidebar-2'][$suf_wa_sb2b_style]['after_widget'],
	'before_title' => $sidebar_definitions['sidebar-2'][$suf_wa_sb2b_style]['before_title'],
	'after_title' => $sidebar_definitions['sidebar-2'][$suf_wa_sb2b_style]['after_title'],
));
register_sidebar(array(
	...
	'before_widget' => $sidebar_definitions['sidebar-1'][$suf_wa_wst_style]['before_widget'],
	'after_widget' => $sidebar_definitions['sidebar-1'][$suf_wa_wst_style]['after_widget'],
	'before_title' => $sidebar_definitions['sidebar-1'][$suf_wa_wst_style]['before_title'],
	'after_title' => $sidebar_definitions['sidebar-1'][$suf_wa_wst_style]['after_title'],
));
register_sidebar(array(
	...
	'before_widget' => $sidebar_definitions['sidebar-1'][$suf_wa_wsb_style]['before_widget'],
	'after_widget' => $sidebar_definitions['sidebar-1'][$suf_wa_wsb_style]['after_widget'],
	'before_title' => $sidebar_definitions['sidebar-1'][$suf_wa_wsb_style]['before_title'],
	'after_title' => $sidebar_definitions['sidebar-1'][$suf_wa_wsb_style]['after_title'],
));
...
register_sidebar(array (
	...
	'before_widget' => $sidebar_definitions['widget-area-below-header'][$suf_wa_wabh_style]['before_widget'],
	'after_widget' => $sidebar_definitions['widget-area-below-header'][$suf_wa_wabh_style]['after_widget'],
	'before_title' => $sidebar_definitions['widget-area-below-header'][$suf_wa_wabh_style]['before_title'],
	'after_title' => $sidebar_definitions['widget-area-below-header'][$suf_wa_wabh_style]['after_title'],
));
register_sidebar(array (
	"name" => "Widget Area Above Footer",
	'id' => 'sidebar-5',
	"description" => "This appears below the content, just above the footer. It is as wide as the page.",
	'before_widget' => $sidebar_definitions['widget-area-above-footer'][$suf_wa_waaf_style]['before_widget'],
	'after_widget' => $sidebar_definitions['widget-area-above-footer'][$suf_wa_waaf_style]['after_widget'],
	'before_title' => $sidebar_definitions['widget-area-above-footer'][$suf_wa_waaf_style]['before_title'],
	'after_title' => $sidebar_definitions['widget-area-above-footer'][$suf_wa_waaf_style]['after_title'],
));
register_sidebar(array (
...
register_sidebar(array (
	...
	'before_widget' => $sidebar_definitions['top-bar-right-widgets'][$suf_wa_tbrh_style]['before_widget'],
	'after_widget' => $sidebar_definitions['top-bar-right-widgets'][$suf_wa_tbrh_style]['after_widget'],
	'before_title' => $sidebar_definitions['top-bar-right-widgets'][$suf_wa_tbrh_style]['before_title'],
	'after_title' => $sidebar_definitions['top-bar-right-widgets'][$suf_wa_tbrh_style]['after_title'],
));
register_sidebar(array (
